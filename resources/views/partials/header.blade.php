<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="{{route('products.index')}}">Rahim Store</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="{{route('products.create')}}">Create</a>
                </li>
            </ul>
            <form style="margin-right: 25px;" class="d-flex mr-5 " action="{{route('products.filter')}}" method="get">
